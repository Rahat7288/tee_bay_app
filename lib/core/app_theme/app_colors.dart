...
class AppColor {
  ...
  static const Color primaryButtonColor = Color(0XFFC780FA);
  static const Color secondaryButtonColor = Color(0XFFE3ACF9);
  ...
  static const Color buttonTextColor = Color(0XFFF4EEE0);
